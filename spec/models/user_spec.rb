...
RSpec.describe User, type: :model do
  ...
  it "User last 3 posts" do
    user = User.create(Name: 'John', Photo: 'www.google.com', Bio: 'Male')
    post1 = Post.create(user_id: 1, Title: "Title1", Text: "Hello1")
    post2 = Post.create(user_id: 1, Title: "Title1", Text: "Hello2")
    post3 = Post.create(user_id: 1, Title: "Title1", Text: "Hello3")
    post4 = Post.create(user_id: 1, Title: "Title1", Text: "Hello4")
